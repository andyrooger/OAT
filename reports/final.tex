...
other obfuscations from an analyser. 

\subsection{Irrelevant Branching}

\# Performance, limitations (such as what our automarker can and can't do), compare with layout obfuscators and automation
