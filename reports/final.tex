...
Having made these decisions we can see we only need to design and write our AST to source writer. We shall now describe a solid design and
extendable implementation for this. The design is fairly simple.
