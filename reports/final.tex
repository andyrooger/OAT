...
We can quickly show this property as \texttt{calculate\_mark} calls itself through \texttt{resolve\_marks}, but only on child nodes. Therefore we have
...
\subsubsection{Implementing Marking Calculation - First Try}
