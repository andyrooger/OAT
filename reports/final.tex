...
As there are a lot of positives for this data structure, and as we are forced at least to begin with an \texttt{ast.AST} node, it does not make sense
to start again from scratch. Instead our solution will be to create a wrapper class. This will hold our actual node, but provide a new set of children - the
wrapped version of each of our original children.
