...
\subsubsection{Discussion on Read and Write Regions for Statements}
...
\begin{itemize}
\item Any node inside $B$ or that is executable by a node in $B$ must only assign only to simple names.
...
\subsubsection{Read and Write Regions for Statements}
