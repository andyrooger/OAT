...
using \texttt{node["field"]}, or iterate using \texttt{for field in node}.
...
\lstinputlisting[language=obftool,basicstyle=\small,breaklines=true]{../snippets/commandsession.log}
