...
\centering
\scalebox{0.75}
{\includegraphics{../randomreorderperf.eps}}
\end{figure}
...
\centering
\scalebox{0.75}
{\includegraphics{../lengthperf.eps}}
\end{figure}
...
\begin{figure}[h]
\centering
\subfloat{\scalebox{0.55}{\includegraphics{../visprob.eps}}}
\subfloat{\scalebox{0.55}{\includegraphics{../breakprob.eps}}}
\end{figure}
...
\begin{figure}[h]
\centering
\subfloat{\scalebox{0.55}{\includegraphics{../readprob.eps}}}
\subfloat{\scalebox{0.55}{\includegraphics{../writeprob.eps}}}
\end{figure}
...
Another useful feature would be to enable the user to work on mutliple files at once. This would be much simpler in a graphical interface and would allow
