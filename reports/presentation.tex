...
\begin{itemize}
\only<2-5>{\item ?}
\only<6-7, 9-10, 13-14>{\item Not visible to user \item Non-breaking \item Does not read or write}
\only<8,11>{\item Not visible to user \item Possibly breaking \item Does not read or write}
\only<12>{\item Not visible to user \item Possibly Breaking \item Reads 'print'}
...
\begin{frame}{Demo}
\resizebox{\textwidth}{!}{
\includegraphics{../images/pctechsupportcat.eps}}
\end{frame}
