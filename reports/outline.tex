...
to assess its effectiveness. To create this there need to be a few basic building blocks. Specifically the following:

\begin{itemize}
\item A Python parser/lexer to read and make sense of Python source files.
\item Hooks for any number of possible obfuscating transformations.
\item Hooks for any number of possible analysis techniques.
